...
#define MY_INHERITANCE 0xBE /* invalid value to proof behavior */
    ...
    void *pChrCmpIW = ChrCmpIW;
#else
    void *pChrCmpIW = GetProcAddress(hShlwapi, "ChrCmpIW");
#endif
    if (!pChrCmpIW)
      printf("ChrCmpIW not available\n");

    pGetShellSecurityDescriptor=(void*)GetProcAddress(hShlwapi, MAKEINTRESOURCE(475));
...
#ifdef TEST_SHLWAPI_H
    void *pColorAdjustLuma = ColorAdjustLuma;
#else
...
static void test_SHCreateWorkerWindowA(void)
{
    ...
    res = GetClassInfoA(hShlwapi, "WorkerA", &cliA);
...
#ifdef TEST_SHLWAPI_H
    void *pPathBuildRootW = PathBuildRootW;
#else
...
{
#define MAKEFUNC(f, ord) (p##f = (void*)GetProcAddress(hShlwapi, MAKEINTRESOURCE(ord)))
...
START_TEST(ordinal)
{
    ...
    is_win9x = GetProcAddress(hShlwapi, MAKEINTRESOURCE(99)) == 0; /* StrCpyNXA */
